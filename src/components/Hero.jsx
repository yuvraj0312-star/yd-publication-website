            ...
            <div className="lg:w-7/12">
              <div className="animate-fade-in-up">
                ...
                <p className="text-xl text-muted-foreground mb-10 max-w-2xl leading-relaxed">
                  Assignment likhna ho ya fir exam aane vali ho, Bohot se mere bhai aur behen, apne friends ko call krenge aur yha vha se thode bohot photos mangenge(Samne vala fir usko WAIT krvata hai...Aura negetive), ya fir groups me dhundega ki khi se free ki pdf mil jaye, past papers mil jaye...Vo sare problems ko mitane k liye hmne YD App bnai hai..jo aapko ek coffee ki price me books provide krti hai
                </p>
