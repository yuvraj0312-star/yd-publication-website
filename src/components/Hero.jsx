        ...
        <div className="w-full border-t border-border bg-white/50">
          <div className="container mx-auto max-w-7xl px-4 md:px-8 py-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              ...
              <div className="flex flex-col gap-2">
                <span className="text-3xl font-display font-extrabold text-navy flex items-center gap-2">₹500 <span className="text-amber-600 text-xs font-bold bg-amber-100 px-2 py-1 rounded-full uppercase tracking-wide">Best Deal- offer till 31st Nov.</span></span>
